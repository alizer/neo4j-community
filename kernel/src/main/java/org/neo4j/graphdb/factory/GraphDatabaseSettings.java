...
/*
 ...
 If you add any new settings here, please make sure that you use the (not deprecated) interface Setting<T> as the field
...
public abstract class GraphDatabaseSettings
{
    ...
    public static final Setting gcr_node_cache_size = new GCRMemoryUsageSetting( "node_cache_size");

    @Description( "The amount of memory to use for the relationship cache (when using the 'gcr' cache)." )
    public static final Setting gcr_relationship_cache_size = new GCRMemoryUsageSetting( "relationship_cache_size");
    ...
    @Default( "60s" )
    public static final Setting gcr_cache_log_interval = new TimeSpanSetting( "gcr_cache_min_log_interval");
